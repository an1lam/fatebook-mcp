...
class Forecast(BaseModel):
    ...
    option_id: Optional[Union[str, int]] = Field(None, alias="optionId", description="For multi-choice questions")
...
class Question(BaseModel):
    ...
    forecasts: Optional[List[Forecast]] = Field(default=None, description="List of forecasts on this question")
